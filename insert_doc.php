            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                       <u> <h1 class="h3 mb-0 text-gray-800">ADD DOCTOR</h1></u>
                    </div>

                    <!-- Content Row -->
                    <div class="row">
                         <form action="database/add_doctor_script.php" method="POST" class="row g-3">
                            <div class="col-md-6">
                          ...
                          <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="doc_email" id="doc_email">
                          </div>
                          <div class="col-md-6">
                            <label for="doc_password" class="form-label">Password</label>
                            <input type="text" class="form-control" name="doc_password" id="doc_password">
                          </div>
                          <!-- <div class="col-md-6">
                          ...
                          <div class="col-6">
                            ...
                            <input type="text" class="form-control" name="doc_dept" id="doc_dept" >
                          </div>
                          <div class="col-6">
                          ...
                          <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="doc_education" id="doc_education">
                          </div>
                           <div class="col-md-6">
                            <label for="doc_exp" class="form-label">Doctor Experience</label>
                            <input type="text" class="form-control" name="doc_exp" id="doc_exp">
                          </div>
                           <!-- <div class="col-md-6">
                          ...
                          <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="doc_phone" id="doc_phone">
                          </div>
                          <div class="col-md-6">
                            <label for="doc_addrr" class="form-label">Address</label>
                            <input type="text" class="form-control" name="doc_addrr" id="doc_addrr">
                          </div>
                           <div class="col-md-6">
                            <label for="doc_fees" class="form-label">Fees</label>
                            <input type="text" class="form-control" name="doc_fees" id="doc_fees">
                          </div>
                          <!-- <div class="col-md-4">
