      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
           <u> <h1 class="h3 mb-0 text-gray-800">MLT'S PROFILE</h1></u>
          </div>
          ...
          <div class="row">
           <form action="database/edit_mlt_script.php?id=<?php echo $_GET['id'] ?>" method="POST" class="row g-3">
            <div class="col-md-6">
              ...
              <input type="text" class="form-control" name="mlt_name" id="mlt_name" value="<?php echo $row['mlt_name'] ?>"disabled>
            </div>
            <div class="col-md-6">
              <label for="mlt_email" class="form-label">Email Address</label>
              <input type="text" class="form-control" name="mlt_email" id="mlt_email" value="<?php echo $row['mlt_email'] ?>"disabled>
            </div>
            <div class="col-md-6">
              <label for="mlt_password" class="form-label">Password</label>
              <input type="text" class="form-control" name="mlt_password" id="mlt_password" value="<?php echo $row['mlt_password'] ?>"disabled>
           </div>
          <!--  <div class="col-md-6">
            ...
            <div class="col-6">
              ...
              <input type="text" class="form-control" name="mlt_dept" id="mlt_dept" value="<?php echo $row['mlt_dept'] ?>"disabled>
            </div>
          <!--  <div class="col-6">
            ...
            <div class="col-md-6">
              ...
              <input type="text" class="form-control" name="mlt_education" id="mlt_education" value="<?php echo $row['mlt_education'] ?>"disabled>
            </div>
            <div class="col-md-6">
              <label for="mlt_exp" class="form-label">Experience</label>
              <input type="text" class="form-control" name="mlt_exp" id="mlt_exp" value="<?php echo $row['mlt_exp'] ?>"disabled>
            </div>
          <!-- <div class="col-md-6">
            ...
            <div class="col-md-6">
              ...
              <input type="text" class="form-control" name="mlt_phone" id="mlt_phone" value="<?php echo $row['mlt_phone'] ?>"disabled>
            </div>
            <div class="col-md-6">
              <label for="mlt_addrr" class="form-label">Address</label>
              <input type="text" class="form-control" name="mlt_addrr" id="mlt_addrr" value="<?php echo $row['mlt_addrr'] ?>"disabled>
            </div>
